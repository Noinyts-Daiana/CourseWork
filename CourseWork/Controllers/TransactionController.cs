...
{
    [HttpGet("journal")]
    [RequirePermission("ViewFinanceJournal")]
        ...
        [FromQuery] int pageSize = 10)
    {
        ...
        return Ok(new { items = transactions, totalCount, pageNumber, pageSize });
    }
        ...
        [FromQuery] int pageSize = 10)
    {
        ...
        return Ok(new { items = categories, totalCount, pageNumber, pageSize });
    }

    [HttpPost]
    [RequirePermission("ManageFinanceJournal")]
